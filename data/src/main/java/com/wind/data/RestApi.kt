...
interface AuthApi {
    ...
    @GET("gallery/all")
    suspend fun getGallery(@QueryMap queryMap: Map<String, String>): DeviantArtList<Art>
    @GET("browse/user/journals")
    suspend fun getJournal(@QueryMap queryMap: Map<String, String>): DeviantArtList<Art>
}
