 ...
 */
data class GetUserGalleryListParam(val pageSize: Int, val userName: String)

class GetUserGalleryUseCase @Inject constructor(
    @IoDispatcher private val coroutineDispatcher: CoroutineDispatcher,
    private val repository: Repository)
    : PageUseCase<GetUserGalleryListParam, Art>(coroutineDispatcher) {
    override fun execute(parameters: GetUserGalleryListParam) =
