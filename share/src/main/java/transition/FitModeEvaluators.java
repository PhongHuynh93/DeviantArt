...
class FitModeEvaluators {
  ...
  static FitModeEvaluator get(
          @LayoutTransform.FitMode int fitMode, boolean entering, RectF startBounds, RectF endBounds) {
    switch (fitMode) {
      case LayoutTransform.FIT_MODE_AUTO:
        return shouldAutoFitToWidth(entering, startBounds, endBounds) ? WIDTH : HEIGHT;
      case LayoutTransform.FIT_MODE_WIDTH:
        return WIDTH;
      case LayoutTransform.FIT_MODE_HEIGHT:
        return HEIGHT;
      default:
